...
export class ServicioService {
    ...
    getListProductNegocio(estado): Observable<any> {
        return this._http.get(this._datosGlobales.urlApi + this.tblName + '/getAllServiceNegocio/' + estado, { headers: this.httpHeaders });
    }
    ...
    uploadImage(file: File, _idproducto): Observable<any> {
        console.log("Subidad de imagen front");
