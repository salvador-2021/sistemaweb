...
@Component({
  ...
  styleUrls: ['./add-pintura.component.css'],
...
export class AddPinturaComponent implements OnInit {
  ...
  private dataModelUpdate: PinturaModel;
  ...
  constructor(
    ...
    this.dataModel = new PinturaModel("", "", "", "", "", "", "", "", 0, 0, null, null);

    //VALIDACION DEL FORMULARIO
    this.validacionForm = this.formBuilder.group({
      nombre: ['', [Validators.required, Validators.maxLength(50)]],
      descripcion: ['', [Validators.nullValidator, Validators.maxLength(100)]],
      litros: ['', [Validators.required, Validators.maxLength(100)]],
  ...
  datosEdit() {
    ...
    this._activatedRoute.params.subscribe(params => {
      ...
      if (_id) {
        ...
        this._pinturaService.getProductNegocio(_id).subscribe(
              ...
              this.validacionForm.setValue(
                {
                  ...
                  litros: this.dataModelUpdate[0].litros,
  ...
  recogerAsignar() {
    ...
    this.dataModel.litros = this.validacionForm.value.litros;
  ...
  uploadImage() {
    ...
    if (this.listImagen.length < 3) {
      ...
      this._pinturaService.uploadImage(this.currentFileUpload, this._idProducto).subscribe(
        event => {
  ...
  getImageName(nameImage) {
    ...
    this._pinturaService.getImageName(nameImage).subscribe(
      response => {
  ...
  deleteImage(nameImage) {
    this._pinturaService.deleteImageProduct(nameImage).subscribe(
      response => {
