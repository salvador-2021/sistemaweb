...
export class AddRelojeriaComponent implements OnInit {
  ...
  constructor(
    ...
    this.dataModel = new RelojeriaModel("", "", "", "", "", "", "", "", "", "", "", "", 0, 0, null, null);
    ...
    this.validacionForm = this.formBuilder.group({
      ...
      modelo: ['', [Validators.nullValidator, Validators.maxLength(40)]],
      caratula: ['', [Validators.nullValidator, Validators.maxLength(40)]],
      ...
      funcionamiento: ['', [Validators.nullValidator, Validators.maxLength(40)]],
