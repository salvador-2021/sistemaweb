...
export class AddLicuadoraComponent implements OnInit {
  ...
  constructor(
    ...
    this.dataModel = new LicuadoraModel("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 0, 0, null, null);
    ...
    this.validacionForm = this.formBuilder.group({
      ...
      accesorios: ['', [Validators.nullValidator, Validators.maxLength(70)]],
      voltaje: ['', [Validators.required, Validators.maxLength(20)]],
      potencia: ['', [Validators.required, Validators.maxLength(20)]],
      velocidades: ['', [Validators.required, Validators.maxLength(30)]],
      capacidad: ['', [Validators.required, Validators.maxLength(40)]],
      material: ['', [Validators.required, Validators.maxLength(50)]],
      peso: ['', [Validators.required, Validators.maxLength(20)]],
      incluye: ['', [Validators.nullValidator, Validators.maxLength(50)]],
      garantia: ['', [Validators.required, Validators.maxLength(70)]],
