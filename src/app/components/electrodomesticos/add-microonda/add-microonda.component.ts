...
@Component({
  selector: 'app-add-microonda',
  templateUrl: './add-microonda.component.html',
  styleUrls: ['./add-microonda.component.css'],
  providers: [MicroondaService]
})

export class AddMicroondaComponent implements OnInit {

  @ViewChild("contenedorImg") contenedorImg: ElementRef;

  private dataModel: MicroondaModel;
  public validacionForm: FormGroup;

  private dataModelUpdate: MicroondaModel;
  ...
  constructor(
    ...
    this.validacionForm = this.formBuilder.group({
      ...
      voltaje: ['', [Validators.required, Validators.maxLength(20)]],
      potencia: ['', [Validators.required, Validators.maxLength(20)]],
      color: ['', [Validators.required, Validators.maxLength(20)]],
      medidas: ['', [Validators.required, Validators.maxLength(40)]],
      luz_interior: ['', [Validators.required, Validators.maxLength(20)]],
      reloj: ['', [Validators.required, Validators.maxLength(20)]],
      panel_control: ['', [Validators.required, Validators.maxLength(20)]],
      peso: ['', [Validators.required, Validators.maxLength(30)]],
      temporizador: ['', [Validators.nullValidator, Validators.maxLength(50)]],
      acabado: ['', [Validators.nullValidator, Validators.maxLength(50)]],
        ...
        this._microondaService.getProductNegocio(_id).subscribe(
          ...
          response => {
            ...
            if (response.status == 'success') {
              ...
              this.dataModelUpdate = response.message.microonda;
              ...
              this.validacionForm.setValue(
                {
                  ...
                  reloj: this.dataModelUpdate[0].reloj,
                  panel_control: this.dataModelUpdate[0].panel_control,
                  peso: this.dataModelUpdate[0].peso,
                  temporizador: this.dataModelUpdate[0].temporizador,
  ...
  recogerAsignar() {
    ...
    this.dataModel.voltaje = this.validacionForm.value.voltaje,
      ...
      this.dataModel.temporizador = this.validacionForm.value.temporizador,
  ...
  uploadImage() {
    ...
    if (this.listImagen.length < 3) {
      ...
      this._microondaService.uploadImage(this.currentFileUpload, this._idProducto).subscribe(
        event => {
  ...
  getImageName(nameImage) {
    ...
    this._microondaService.getImageName(nameImage).subscribe(
      response => {
  ...
  deleteImage(nameImage) {
    this._microondaService.deleteImageProduct(nameImage).subscribe(
      response => {
