...
@Component({
  selector: 'app-tbl-pintura',
  templateUrl: './tbl-pintura.component.html',
  styleUrls: ['./tbl-pintura.component.css'],
  providers: [PinturaService]
})
export class TblPinturaComponent {

  public products: PinturaModel[];
  public title: String;
  ...
  displayedColumns: string[] = ['nombre', 'litros', 'marca', 'color', 'precio_anterior', 'precio', 'existencia', 'fecha_promocion', 'acciones'];
  dataSource: MatTableDataSource<PinturaModel>;
    ...
    this._pinturaService.getProductNegocio(_id).subscribe(
      response => {
        ...
        if (response.status == 'success') {
          ...
          let listImagen = response.message.pintura[0].imagen;
