...
export class TblCarpinteriaComponent {
  ...
  displayedColumns: string[] = ['nombre', 'descripcion', 'unidadventa', 'medidas', 'precio_anterior', 'precio', 'existencia', 'fecha_promocion', 'acciones'];
  dataSource: MatTableDataSource<CarpinteriaModel>;
