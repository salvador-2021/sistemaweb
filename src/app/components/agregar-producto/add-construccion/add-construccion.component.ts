...
@Component({
  ...
  templateUrl: './add-construccion.component.html',
  styleUrls: ['./add-construccion.component.css'],
...
export class AddConstruccionComponent implements OnInit {
  ...
  private dataModelUpdate: ConstruccionModel;
 ...
 */
          ...
          if (response.status == 'success') {
            ...
            Swal.fire("Producto creado",
              ...
              "success").then((value) => {
                ...
                this._router.navigate(['/negocio/agregar-construccion', this._idProducto]);
  ...
  uploadImage() {
    ...
    if (this.listImagen.length < 3) {
      ...
      this._construccionService.uploadImage(this.currentFileUpload, this._idProducto).subscribe(
        event => {
  ...
  getImageName(nameImage) {
    ...
    this._construccionService.getImageName(nameImage).subscribe(
      response => {
  ...
  deleteImage(nameImage) {
    this._construccionService.deleteImageProduct(nameImage).subscribe(
      response => {
