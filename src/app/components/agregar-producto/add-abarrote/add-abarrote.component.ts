...
export class AddAbarroteComponent implements OnInit {
  ...
  private dataModelUpdate: AbarroteModel;
  public editDatos: Boolean;
  public titlePage: String;
  public _idProducto: string;

  //Linea de Productos en ABARROTES
  ...
  constructor(
    ...
    this.validacionForm = this.formBuilder.group({
      ...
      linea: ['Abarrotes', Validators.required],
          ...
          if (response.status == 'success') {            
            ...
            Swal.fire('Producto creado',
              ...
              'success').then((value) => {
                ...
                this._router.navigate(['/negocio/agregar-abarrote', this._idProducto]);
              });
          }
        },
        error => {
