...
export class AddAccesorioCelComponent implements OnInit {
  ...
  private dataModelUpdate: AccesorioMovilModel;
...
>>>>>>> d72b2b283ef5801d40171ef98619a476fe4b9f6c
        ...
        this._accesorioMovilService.getProductNegocio(_id).subscribe(
          ...
          response => {
            ...
            if (response.status == 'success') {
              ...
              this.listImagen = response.message.accesorio_movil[0].imagen;
          ...
          if (response.status == 'success') {
            ...
            Swal.fire("Producto creado",
              ...
              "success").then((value) => {
                ...
                this._router.navigate(['/negocio/agregar-accesorio-movil', this._idProducto]);
              });
...
>>>>>>> d72b2b283ef5801d40171ef98619a476fe4b9f6c
  ...
  uploadImage() {
    ...
    if (this.listImagen.length < 3) {
      ...
      this._accesorioMovilService.uploadImage(this.currentFileUpload, this._idProducto).subscribe(
        event => {
  ...
  getImageName(nameImage) {
    ...
    this._accesorioMovilService.getImageName(nameImage).subscribe(
      response => {
  ...
  deleteImage(nameImage) {
    this._accesorioMovilService.deleteImageProduct(nameImage).subscribe(
      response => {
        if (response.status == 'success') {
