...
export class AddBodegaComponent implements OnInit {
  ...
  private dataModelUpdate: BodegaModel;
        ...
        this._bodegaService.getProductNegocio(_id).subscribe(
          ...
          response => {
            ...
            if (response.status == 'success') {
              ...
              this.listImagen = response.message.bodega[0].imagen;
          ...
          if (response.status == 'success') {
            ...
            Swal.fire("Producto creado",
              ...
              "success").then((value) => {
                ...
                this._router.navigate(['/negocio/agregar-bodega', this._idProducto]);
  ...
  uploadImage() {
    ...
    if (this.listImagen.length < 3) {
      ...
      this._bodegaService.uploadImage(this.currentFileUpload, this._idProducto).subscribe(
        event => {
  ...
  getImageName(nameImage) {
    ...
    this._bodegaService.getImageName(nameImage).subscribe(
      response => {
  ...
  deleteImage(nameImage) {
    this._bodegaService.deleteImageProduct(nameImage).subscribe(
      response => {
