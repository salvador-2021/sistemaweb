...
export class AddMicroondaComponent implements OnInit {
  ...
  constructor(
    ...
    this.validacionForm = this.formBuilder.group({
      ...
      luz_interior: ['', [Validators.required, Validators.maxLength(50)]],
      reloj: ['', [Validators.required, Validators.maxLength(50)]],
      panel_control: ['', [Validators.required, Validators.maxLength(50)]],
