...
export class AddRefrigeradorComponent implements OnInit {
  ...
  constructor(
    ...
    this.validacionForm = this.formBuilder.group({
      ...
      filtro_agua: ['', [Validators.required, Validators.maxLength(50)]],
      ...
      control_humedad: ['', [Validators.required, Validators.maxLength(50)]],
      no_puertas: ['', [Validators.required, Validators.maxLength(50)]],
      despachador_agua: ['', [Validators.required, Validators.maxLength(50)]],
      compartimientos: ['', [Validators.required, Validators.maxLength(50)]],
          ...
          if (response.status == 'success') {
            ...
            Swal.fire("Producto creado",
              ...
              "success").then((value) => {
                ...
                this._router.navigate(['/negocio/add-refrigerador', this._idProducto]);
