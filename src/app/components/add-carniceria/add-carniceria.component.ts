...
@Component({
  ...
  styleUrls: ['./add-carniceria.component.css'],
...
export class AddCarniceriaComponent implements OnInit {
  ...
  private dataModelUpdate: CarniceriaModel;
  ...
  constructor(
    ...
    this.dataModel = new CarniceriaModel("", "", "", "", 0, 0, null, null);
        ...
        this._carniceriaService.getProductNegocio(_id).subscribe(
          ...
          response => {
            ...
            if (response.status == 'success') {
              ...
              this.listImagen = response.message.carniceria[0].imagen;
        ...
        if (response.status == 'success') {
          ...
          Swal.fire("Producto creado",
            ...
            "success").then((value) => {
              ...
              this._router.navigate(['/add-carniceria', this._idProducto]);
  ...
  */
  ...
  uploadImage() {
    ...
    if (this.listImagen.length < 3) {
      ...
      this._carniceriaService.uploadImage(this.currentFileUpload, this._idProducto).subscribe(
        event => {
  ...
  getImageName(nameImage) {
    ...
    this._carniceriaService.getImageName(nameImage).subscribe(
      response => {
